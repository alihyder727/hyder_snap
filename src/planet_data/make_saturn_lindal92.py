...
definition = '''/** @file lindal_sat_inv.cpp"
  *
...
declaration = '''#ifndef LINDAL_SAT_INV_HPP
...
with open('lindal_sat_inv.cpp', 'w') as file:
  file.write(definition)
with open('lindal_sat_inv.hpp', 'w') as file:
