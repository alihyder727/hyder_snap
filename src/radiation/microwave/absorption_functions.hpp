...
double absorption_coefficient_H2O_deBoer(double freq, double P, double T, double XH2, double XHe,
       double XH2O);

double absorption_coefficient_H2O_Waters(double freq, double P, double T, double XH2, double XHe,
       double XH2O);

double absorption_coefficient_H2O_Goodman(double freq, double P, double T, double XH2, double XHe,
       double XH2O);

double absorption_coefficient_H2O_Karpowicz(double freq, double P_idl, double T, double XH2,
